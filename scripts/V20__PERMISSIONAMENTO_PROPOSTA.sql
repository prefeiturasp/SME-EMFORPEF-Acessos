...
from modulos where idmodcoresso = 4 and idsistemacoresso = 1007 and not exists (select 1 from permissoes where idmodulo in (select id from modulos where idmodcoresso = 3 and idsistemacoresso = 1007)
